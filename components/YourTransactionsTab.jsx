...
const YourTransactionsTab = () => {
  ...
  return (
    <div className="flex bg-slate-50 flex-col justify-start items-center w-full ">
      <div className="flex bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 flex-row justify-around items-center w-full bg-gradient-to-b from-[#212430] to-[#17171a] p-3 rounded-t-xl text-start text-[16px]">
        <h1 className="w-3/4 ">Your Transactions</h1>
        <h2 className="w-1/4"> Time</h2>
      </div>

      <div className="flex bg-slate-50 flex-row justify-around items-center w-full p-3 rounded-b-xl text-start text-black text-sm  border border-1">
