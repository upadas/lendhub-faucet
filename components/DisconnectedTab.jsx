...
const DisconnectedTab = () => {
  return (
    <div className="flex justify-center items-center ">
      <div className="flex flex-col w-full bg-white rounded-3xl py-5 md:py-10 px-2 md:max-w-[900px] -mt-14  justify-center items-center text-center ">
        <Image
          src={metamask}
          alt="metamask"
        ...
        <p className="text-sm text-[#62677B] mb-5">
          And Request testing testing Sepolia ETH or Tokens for{" "}
          <a
